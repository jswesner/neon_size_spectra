...
We will develop statistical frameworks to characterize and summarize the temperature regimes of NEON streams. The water temperature data across NEON streams varies in length of record and completeness. We will develop workflows which allow us to characterize the water temperature regimes annually and account for missing values by integrating air temperature records

3) **Quantifying resource availability in NEON streams**

We will quantify the supply of basal resources to consumers across NEON stream ecosystems. Basal resource supply sets the energetic base which feeds higher trophic levels and therefore sets limits on the biomass and trophic levels ecosystems can support. 

#### What was accomplished under these goals (you must provide information for at least one of the 4 categories below)?

##### Major activities:

Through the past year we have made strides towards all three stated objectives. We have developed the workflow and statistical framework to combined the NEON macroinvertebrate and fish assemblage data in comparable units, allowing us to develop multi-trophic size spectra in all streams. We have also developed workflows and statistical frameworks to characterize and summarize stream temperature regimes, including the development of statistical models to impute missing values in the time series.

```{r fig 1, fig.align = 'center', fig.cap= "Figure 2. (Left panel) An example of a single multi-trophic size spectra of fish and invertebrate communities and (right panel) all estimated multi-trophic size spectra from NEON stream sites."}
...
We have initiated the process to on-board a postdoctoral researcher to fill the role vacated by Dr. J.P.Z. Pomeranz upon their appointment to Assistant Professor at Colorado Mesa University. The postdoctoral researcher will work with the 
