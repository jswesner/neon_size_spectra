rm(list = ls())
here::i_am("code/resources/metModelsMLE/MCDI_metModel.R")
source(here::here("code/resources/01_load-packages.R"))
# 
rerun = FALSE
if(rerun){
tictoc::tic();run_metab_multimodel(siteCode = "MCDI", metDf = NULL, return = FALSE, save = TRUE, parallel = FALSE);tictoc::toc()
}
siteCode = 'MCDI'
load(file = here::here("ignore/metab-models/mleModLists/MCDImlemods.Rdata"))
...
# 
# saveRDS(mm3_sat, "./ignore/metab-models/MCDI_full_mle.rds")
