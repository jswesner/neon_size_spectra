rm(list = ls())
here::i_am("code/resources/metModelsMLE/PRIN_metModel.R")
source(here::here("code/resources/01_load-packages.R"))
#
rerun = FALSE
if(rerun){
tictoc::tic();run_metab_multimodel(siteCode = "PRIN", metDf = NULL, return = FALSE, save = TRUE, parallel = FALSE);tictoc::toc()
}
siteCode = 'PRIN'
load(file = here::here("ignore/metab-models/mleModLists/PRINmlemods.Rdata"))
...
# 
# saveRDS(mm4, "./ignore/metab-models/PRIN_full_mle.rds")
